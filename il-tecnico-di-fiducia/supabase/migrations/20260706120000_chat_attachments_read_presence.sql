-- Chat hardening: per-message attachments, read receipts, active chat presence.
-- No demo data; all rows are tied to real conversations/messages.
...
begin
  ...
  set last_message_at = new.created_at,
      last_message_body = coalesce(new.body, 'Allegato'),
