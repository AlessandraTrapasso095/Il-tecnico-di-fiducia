  ...
  return (
    <section className="rounded-[24px] border border-outline-variant/30 bg-surface-container-lowest p-5 shadow-[0_4px_20px_rgba(8,43,95,0.08)] sm:p-6">
      <div className="mb-4 flex items-start justify-between gap-2 sm:gap-4">
        <h2 className="min-w-0 font-headline-sm text-[22px] leading-tight text-primary sm:text-[24px]">
          {title}
        </h2>
        {editable ? (
          <button
            type="button"
            className="min-h-10 shrink-0 whitespace-nowrap rounded-full px-3 py-2 text-xs font-bold leading-none text-primary transition hover:bg-primary-fixed sm:px-4 sm:text-sm"
            onClick={onEdit}
          >
            Modifica
          </button>
